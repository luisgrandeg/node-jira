...
function shipmentsService(requestManager) {
  return {
    searchShipment: function (term) {
      return requestManager('/v1/searchshipment/' + term);
    },

    getShipments: function (offset, limit) {
      return requestManager(BASE_URL, {params: {offset: offset, limit: limit}});
    },

    getDetails: function (id) {
      return requestManager(BASE_URL + '/' + id);
    },
    ...
    getLabel: function (id) {
      return requestManager(BASE_URL + '/' + id + '/labels');
    },

    trackShipment: function (id) {
      return requestManager(BASE_URL + '/' + id + '/track');
    }
  };
}
